...
export function SchoolAnalytics({ theme }: { theme: string }) {
  ...
  const enrollmentTrends = [
    { grade: "DP2", count: 88, growth: "+8% YoY" },
    { grade: "DP1", count: 96, growth: "+12% YoY" },
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
      ...
      <div className={`p-6 rounded-3xl border ${styling.panelBg} space-y-6`}>
        <div>
          <span className="text-[9px] text-cyan-400 font-extrabold uppercase tracking-widest block font-mono">DP Cohort Trends</span>
          <h3 className="text-sm font-bold text-white uppercase tracking-wider mt-0.5">Enrollment & Attendance Trends</h3>
          <p className="text-[11px] text-white/35">Cohort records mapping DP1 and DP2 growth metrics and attendance ratios.</p>
        </div>
      ...
      <div className={`p-6 rounded-3xl border ${styling.panelBg} space-y-6`}>
        <div>
          ...
          <h3 className="text-sm font-bold text-white uppercase tracking-wider mt-0.5">IB Room Usage & Subject Demand</h3>
          <p className="text-[11px] text-white/35">Overview of IA labs, TOK spaces, and high-enrollment DP subjects.</p>
        </div>
      ...
      <div className={`p-6 rounded-3xl border ${styling.panelBg} space-y-6 md:col-span-2`}>
        <div>
          ...
          <p className="text-[11px] text-white/35">Weekly periods and average workload per IB subject group.</p>
        </div>
