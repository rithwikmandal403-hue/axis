    ...
    return (
      <div className="h-full flex flex-col gap-safe-lg text-white p-safe-sm">
        ...
        <div className="flex flex-col gap-1.5">
          <h2 className="text-xl font-bold tracking-tight">Context Workspace</h2>
          <p className="text-xs text-white/50 leading-relaxed max-w-2xl">
            Operational awareness and continuity portal. Access captured interactions, live class attendance discrepancies, room opportunities, and resources generated by the school ecosystem.
          </p>
        </div>
    ...
    <div className="rounded-2xl border border-white/[0.06] bg-white/[0.01] p-safe-lg shadow-[0_8px_32px_-12px_rgba(0,0,0,0.5)]">
      <div className="flex flex-col gap-safe-md">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-white/30 tracking-tight">Active Awareness</span>
        </div>
        ...
        <div className="space-y-safe-md">
          <AnimatePresence initial={false}>
            {activeItems.length === 0 ? (
              ...
              >
                No active notifications in Context.
              </motion.div>
            ) : (
              activeItems.map((item) => (
                <motion.div
