  ...
  const campusAreas: CampusArea[] = [
    {
      ...
      building: "Building A",
      currentActivity: "Grade 11 & 12 Humanities Lectures",
    ...
    },
    {
      ...
      currentActivity: "Coordinators Board Alignment Briefing",
      scheduledActivity: "Period 5: Parent association session",
      responsibleStaff: "Dr. Alistair Vance",
      staffRole: "Head of School",
      maintenanceStatus: "normal",
      occupancy: 14,
      capacity: 30,
      ...
      <div className="xl:col-span-8 space-y-4">
        ...
        <div className="border border-white/[0.08] bg-[#0E0E10]/85 p-6 rounded-3xl min-h-[500px] flex flex-col justify-between backdrop-blur-xl shadow-xl">
          <div className="flex justify-between items-start border-b border-white/[0.06] pb-3 mb-6">
            <div>
              <span className="text-[9px] text-cyan-400 font-extrabold uppercase tracking-widest block">Interactive Campus Directory</span>
              <h3 className="text-sm font-bold text-white mt-0.5">Axis 2D Campus Layout</h3>
              <p className="text-[10px] text-white/35 font-medium mt-0.5">Click any sector on the directory to view supervisor details, schedules, and active counts.</p>
            </div>
        ...
        <AnimatePresence mode="wait">
          {selectedArea ? (
            ...
            <div className="border border-dashed border-white/[0.12] p-8 rounded-3xl h-[460px] flex flex-col justify-center items-center text-center text-xs text-white/30 space-y-2">
              ...
              <p className="max-w-[200px] leading-relaxed mx-auto">Select any 2D campus sector in the directory to inspect occupancy, supervisor, and direct action triggers.</p>
            </div>
          )}
        </AnimatePresence>
      </div>
