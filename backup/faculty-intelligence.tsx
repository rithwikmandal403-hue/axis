  ...
  return (
    <div className="space-y-6">
      ...
      <AnimatePresence mode="wait">
        ...
        {/* VIEW 1: FACULTY INTELLIGENCE SUMMARY */}
        {activeView === "overview" && (
          <motion.div
            key="intel"
          ...
          >
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className={`p-6 rounded-3xl border ${styling.panelBg} space-y-6`}>
                <div>
                  <span className="text-[9px] text-cyan-400 font-extrabold uppercase tracking-widest block">Department Sizes & Ratios</span>
                  <h3 className="text-sm font-bold text-white uppercase tracking-wider">Department Rosters & Workloads</h3>
                  <p className="text-[11px] text-white/35">Click any department card to view specific faculty loads, course responsibilities, and contacts.</p>
                </div>
                ...
                {selectedDept ? (
                  ...
                  >
                    ...
                    <div className="space-y-4 text-xs font-semibold">
                      <span className="text-[9px] text-white/35 font-bold uppercase tracking-wider block">Department Members & Workloads</span>
                  ...
                  <div className={`p-6 rounded-3xl border ${styling.panelBg} text-center py-16 flex flex-col justify-center items-center text-xs text-white/30 space-y-2 h-[320px]`}>
                    ...
                    <h4 className="font-bold text-white/60">No Department Selected</h4>
                    <p className="max-w-[200px] leading-relaxed mx-auto">Select any department card in the grid to inspect staff lists and teach loadings.</p>
                  </div>
                )}
              </AnimatePresence>
            </div>
        ...
        {/* VIEW 2: FACULTY ROSTER SEARCH FINDER */}
        {activeView === "finder" && (
          <motion.div
            key="finder"
            initial={{ opacity: 0, y: 10 }}
